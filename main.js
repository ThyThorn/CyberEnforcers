...
//blue_object =  new Unit('blue',10,5,5,0,'robot',true,);

//this.add.text(450, 360 , 'name: ' + red_object.name + ' hp: '+ red_object.health , { fontSize: '20px', fill: '#FF0000' });

game.physics.arcade.enable(red); // for debug mode
red.enableBody = true;
...
blue_object =  new Unit('blue',10,5,5,0,'robot',true,4,7);
this.add.text(450, 360 , 'name: ' + myarray[7][7].name, { fontSize: '20px', fill: '#FF0000' });	 
    },
...
selected:function(){
	...
	*/
	...
	if(selected_x  >= 960){   
	...
	}else if(selected_x - redX <= 2 && selected_x - redX > 0 && redY  == selected_y && red_object.turnEnd == false ){
	 ...
	 //  this.add.text(450, 500 , 'name: ' + myarray[red_object.xPlace][red_object.yPlace].name, { fontSize: '20px', fill: '#FF0000' });
	   
	}else if (redX - selected_x <= 2 && selected_x - redX < 0 && redY  == selected_y && red_object.turnEnd == false ){
	...
	}else if (selected_y - redY <= 2 && selected_y - redY > 0 && redX == selected_x && red_object.turnEnd == false ){
	...
	}else if (redY - selected_y <= 2 && selected_y - redY < 0 && redX  == selected_x  && red_object.turnEnd == false ){
